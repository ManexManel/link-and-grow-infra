...
export function SectionMiniFooter({ services }: SectionMiniFooterProps) {
  return (
    <footer
      style={{
    ...
    >
      ...
      <div style={{ width: "320px", flexShrink: 0 }}>
        ...
        <ul style={{ listStyle: "none", margin: 0, padding: 0 }}>
          {services.map((service) => (
            <li key={service} style={serviceItemStyle}>
              {service}
            </li>
          ))}
        </ul>
      ...
      <div style={{ width: "180px", flexShrink: 0 }}>
        ...
        >
          ...
          {/* LinkedIn */}
          <a
            href="https://www.linkedin.com/company/omedia-paris"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn"
            style={{ color: "#000", display: "flex" }}
